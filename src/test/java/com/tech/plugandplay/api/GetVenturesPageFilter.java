...
public class GetVenturesPageFilter {
	...
	public static void getActiveClusters(){ //verticals="+verticals+"&
		...
		Response response = RestAssured.get("http://"+hostname+":8080/plugandplay/api/v1/ventures/filter/3?verticals="+verticals+"&stage="+stage+"&tags="+tags);
