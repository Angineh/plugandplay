...
public class GetVenturesPageGlobal {
	
	static String hostname = "localhost";
	static String query = "China";
	static String pnpOffices = "Plug and Play China"; //,FinTech - New York
	
	@Test
	public static void getActiveClusters(){
		Response response = RestAssured.get("http://"+hostname+":8080/plugandplay/api/v1/ventures/query/1?query="+query+"&pnpOffices="+pnpOffices);
