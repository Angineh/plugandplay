...
public class GetTop20List {
	
	static String hostname = "54.145.172.103";//"localhost";
...
/*	@BeforeClass
	...
	public static void getTop100List(){
		Response response = RestAssured.get("http://"+hostname+":8080/plugandplay/api/v1/top20/lists");
		System.out.println("Get top 20 list status code: "+response.getStatusCode());
